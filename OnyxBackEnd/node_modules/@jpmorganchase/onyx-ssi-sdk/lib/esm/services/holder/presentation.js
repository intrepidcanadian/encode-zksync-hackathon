import { DEFAULT_CONTEXT, JWTService, VERIFIABLE_PRESENTATION } from "../common";
/**
 ...
 */
export function createPresentation(holderDid, verifiableCredentials, additionalProperties) {
    let presentation = {};
 ...
 */
export async function createAndSignPresentationJWT(holder, verifiableCredentials, options) {
 ...
 */
export function getCredentialsFromVP(vp) {
    const jwtService = new JWTService();
    if (typeof vp === 'string') {
        const decoded = jwtService.decodeJWT(vp)?.payload;
