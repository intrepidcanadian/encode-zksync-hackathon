...
export class SchemaManager {
     ...
     */
    static async getSchemaRemote(schemaLocation) {
     ...
     */
    static async getSchemaFromFile(schemaLocation) {
        const schema = await HelperUtils.fileReaderJSON(schemaLocation);
        const validated = await this.validateSchema(schema);
        if (!validated) {
            throw new SchemaValidationFailureError('Retrieved Schema failed validation');
        }
     ...
     */
    static async getSchemaSpec(schema) {
